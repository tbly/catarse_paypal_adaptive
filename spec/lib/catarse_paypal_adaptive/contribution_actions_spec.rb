...
describe CatarsePaypalAdaptive::ContributionActions do
  let(:contribution_actions) { CatarsePaypalAdaptive::ContributionActions.new(contribution) }
  ...
  before do
    CatarsePaypalAdaptive::Gateway.stub(:instance).and_return(gateway)
  end
